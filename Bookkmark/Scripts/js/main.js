(function() {
  ...
  function menuItemListener( link ) {
      ...
      var height = 305;
      var width = 500;
      window.open("/bookkmark/bookkmark/manage?id=" + taskId + "&action=" + taskAction, "_blank", "toolbar=no,scrollbars=no,resizable=no,top=" + top + ",left=" + left + ",width=" + width + ",height=" + height + "");
